...
//Command     : generate_target axi_stream_receiver.bd
//Design      : axi_stream_receiver
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "axi_stream_receiver,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=axi_stream_receiver,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=1,numReposBlks=1,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "axi_stream_receiver.hwdef" *) 
module axi_stream_receiver
   (M_AXIS_SLAVE_0_tdata,
    ...
    s_axi_aclk_0,
    s_axi_aresetn_0);
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 M_AXIS_SLAVE_0 TDATA" *) (* X_INTERFACE_MODE = "Master" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME M_AXIS_SLAVE_0, CLK_DOMAIN axi_stream_receiver_s_axi_aclk_0, FREQ_HZ 100000000, HAS_TKEEP 1, HAS_TLAST 1, HAS_TREADY 1, HAS_TSTRB 1, INSERT_VIP 0, LAYERED_METADATA undef, PHASE 0.0, TDATA_NUM_BYTES 128, TDEST_WIDTH 8, TID_WIDTH 16, TUSER_WIDTH 256" *) output [1023:0]M_AXIS_SLAVE_0_tdata;
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 M_AXIS_SLAVE_0 TDEST" *) output [7:0]M_AXIS_SLAVE_0_tdest;
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 M_AXIS_SLAVE_0 TID" *) output [15:0]M_AXIS_SLAVE_0_tid;
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 M_AXIS_SLAVE_0 TKEEP" *) output [127:0]M_AXIS_SLAVE_0_tkeep;
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 M_AXIS_SLAVE_0 TLAST" *) output M_AXIS_SLAVE_0_tlast;
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 M_AXIS_SLAVE_0 TREADY" *) input M_AXIS_SLAVE_0_tready;
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 M_AXIS_SLAVE_0 TSTRB" *) output [127:0]M_AXIS_SLAVE_0_tstrb;
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 M_AXIS_SLAVE_0 TUSER" *) output [255:0]M_AXIS_SLAVE_0_tuser;
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 M_AXIS_SLAVE_0 TVALID" *) output M_AXIS_SLAVE_0_tvalid;
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 S_AXIS_SLAVE_0 TDATA" *) (* X_INTERFACE_MODE = "Slave" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME S_AXIS_SLAVE_0, CLK_DOMAIN axi_stream_receiver_s_axi_aclk_0, FREQ_HZ 100000000, HAS_TKEEP 1, HAS_TLAST 1, HAS_TREADY 1, HAS_TSTRB 1, INSERT_VIP 0, LAYERED_METADATA undef, PHASE 0.0, TDATA_NUM_BYTES 128, TDEST_WIDTH 8, TID_WIDTH 16, TUSER_WIDTH 256" *) input [1023:0]S_AXIS_SLAVE_0_tdata;
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 S_AXIS_SLAVE_0 TDEST" *) input [7:0]S_AXIS_SLAVE_0_tdest;
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 S_AXIS_SLAVE_0 TID" *) input [15:0]S_AXIS_SLAVE_0_tid;
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 S_AXIS_SLAVE_0 TKEEP" *) input [127:0]S_AXIS_SLAVE_0_tkeep;
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 S_AXIS_SLAVE_0 TLAST" *) input S_AXIS_SLAVE_0_tlast;
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 S_AXIS_SLAVE_0 TREADY" *) output S_AXIS_SLAVE_0_tready;
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 S_AXIS_SLAVE_0 TSTRB" *) input [127:0]S_AXIS_SLAVE_0_tstrb;
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 S_AXIS_SLAVE_0 TUSER" *) input [255:0]S_AXIS_SLAVE_0_tuser;
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 S_AXIS_SLAVE_0 TVALID" *) input S_AXIS_SLAVE_0_tvalid;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 S_AXI_0 ARADDR" *) (* X_INTERFACE_MODE = "Slave" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME S_AXI_0, ADDR_WIDTH 32, ARUSER_WIDTH 8, AWUSER_WIDTH 8, BUSER_WIDTH 0, CLK_DOMAIN axi_stream_receiver_s_axi_aclk_0, DATA_WIDTH 32, FREQ_HZ 100000000, HAS_BRESP 1, HAS_BURST 1, HAS_CACHE 1, HAS_LOCK 1, HAS_PROT 1, HAS_QOS 1, HAS_REGION 0, HAS_RRESP 1, HAS_WSTRB 1, ID_WIDTH 1, INSERT_VIP 0, MAX_BURST_LENGTH 256, NUM_READ_OUTSTANDING 7, NUM_READ_THREADS 1, NUM_WRITE_OUTSTANDING 7, NUM_WRITE_THREADS 1, PHASE 0.0, PROTOCOL AXI4, READ_WRITE_MODE READ_WRITE, RUSER_BITS_PER_BYTE 0, RUSER_WIDTH 0, SUPPORTS_NARROW_BURST 1, WUSER_BITS_PER_BYTE 0, WUSER_WIDTH 0" *) input [31:0]S_AXI_0_araddr;
  ...
  output err_out_0;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.S_AXI_ACLK_0 CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.S_AXI_ACLK_0, ASSOCIATED_BUSIF M_AXIS_SLAVE_0:S_AXI_0:S_AXIS_SLAVE_0, ASSOCIATED_RESET s_axi_aresetn_0, CLK_DOMAIN axi_stream_receiver_s_axi_aclk_0, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input s_axi_aclk_0;
  ...
  axi_stream_receiver_axi_traffic_gen_0_0 axi_receiver_gen
       (.err_out(err_out_0),
        .m_axis_2_tdata(M_AXIS_SLAVE_0_tdata),
        .m_axis_2_tdest(M_AXIS_SLAVE_0_tdest),
        .m_axis_2_tid(M_AXIS_SLAVE_0_tid),
        .m_axis_2_tkeep(M_AXIS_SLAVE_0_tkeep),
        .m_axis_2_tlast(M_AXIS_SLAVE_0_tlast),
        .m_axis_2_tready(M_AXIS_SLAVE_0_tready),
        .m_axis_2_tstrb(M_AXIS_SLAVE_0_tstrb),
        .m_axis_2_tuser(M_AXIS_SLAVE_0_tuser),
        .m_axis_2_tvalid(M_AXIS_SLAVE_0_tvalid),
        ...
        .s_axis_2_tdata(S_AXIS_SLAVE_0_tdata),
        .s_axis_2_tdest(S_AXIS_SLAVE_0_tdest),
        .s_axis_2_tid(S_AXIS_SLAVE_0_tid),
        .s_axis_2_tkeep(S_AXIS_SLAVE_0_tkeep),
        .s_axis_2_tlast(S_AXIS_SLAVE_0_tlast),
        .s_axis_2_tready(S_AXIS_SLAVE_0_tready),
        .s_axis_2_tstrb(S_AXIS_SLAVE_0_tstrb),
        .s_axis_2_tuser(S_AXIS_SLAVE_0_tuser),
        .s_axis_2_tvalid(S_AXIS_SLAVE_0_tvalid));
endmodule
