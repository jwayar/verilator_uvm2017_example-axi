...
vlog -work xil_defaultlib -L xilinx_vip -64 -incr -mfcu "+incdir+$sim_models_dir/incl" "+incdir+$xilinx_vip_incl_path"\
  "$sim_models_dir/src/axi_stream_master_axi_traffic_gen_0_0.v" \
  "$sim_models_dir/src/axi_stream_master.v" \
  "$sim_models_dir/src/axi_stream_receiver_axi_traffic_gen_0_0.v" \
  "$sim_models_dir/src/axi_stream_receiver.v" \
