...
//Date        : Tue Aug 26 14:07:36 2025
//Host        : Juan running 64-bit major release  (build 9200)
//Command     : generate_target axi_stream_receiver_256.bd
//Design      : axi_stream_receiver_256
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "axi_stream_receiver_256,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=axi_stream_receiver_256,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=1,numReposBlks=1,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "axi_stream_receiver_256.hwdef" *) 
module axi_stream_receiver_256
   (M_AXIS_MASTER_0_tdata,
    ...
    S_AXIS_MASTER_0_tdata,
    S_AXIS_MASTER_0_tdest,
    S_AXIS_MASTER_0_tid,
    S_AXIS_MASTER_0_tkeep,
    S_AXIS_MASTER_0_tlast,
    S_AXIS_MASTER_0_tready,
    S_AXIS_MASTER_0_tstrb,
    S_AXIS_MASTER_0_tuser,
    S_AXIS_MASTER_0_tvalid,
    S_AXI_0_araddr,
    S_AXI_0_arburst,
    S_AXI_0_arcache,
    S_AXI_0_arid,
    ...
    s_axi_aclk_0,
    s_axi_aresetn_0);
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 M_AXIS_MASTER_0 TDATA" *) (* X_INTERFACE_MODE = "Master" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME M_AXIS_MASTER_0, CLK_DOMAIN axi_stream_receiver_256_s_axi_aclk_0, FREQ_HZ 100000000, HAS_TKEEP 1, HAS_TLAST 1, HAS_TREADY 1, HAS_TSTRB 1, INSERT_VIP 0, LAYERED_METADATA undef, PHASE 0.0, TDATA_NUM_BYTES 32, TDEST_WIDTH 8, TID_WIDTH 16, TUSER_WIDTH 256" *) output [255:0]M_AXIS_MASTER_0_tdata;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 M_AXIS_MASTER_0 TKEEP" *) output [31:0]M_AXIS_MASTER_0_tkeep;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 M_AXIS_MASTER_0 TSTRB" *) output [31:0]M_AXIS_MASTER_0_tstrb;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 S_AXIS_MASTER_0 TDATA" *) (* X_INTERFACE_MODE = "Slave" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME S_AXIS_MASTER_0, CLK_DOMAIN axi_stream_receiver_256_s_axi_aclk_0, FREQ_HZ 100000000, HAS_TKEEP 1, HAS_TLAST 1, HAS_TREADY 1, HAS_TSTRB 1, INSERT_VIP 0, LAYERED_METADATA undef, PHASE 0.0, TDATA_NUM_BYTES 32, TDEST_WIDTH 8, TID_WIDTH 16, TUSER_WIDTH 256" *) input [255:0]S_AXIS_MASTER_0_tdata;
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 S_AXIS_MASTER_0 TDEST" *) input [7:0]S_AXIS_MASTER_0_tdest;
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 S_AXIS_MASTER_0 TID" *) input [15:0]S_AXIS_MASTER_0_tid;
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 S_AXIS_MASTER_0 TKEEP" *) input [31:0]S_AXIS_MASTER_0_tkeep;
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 S_AXIS_MASTER_0 TLAST" *) input S_AXIS_MASTER_0_tlast;
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 S_AXIS_MASTER_0 TREADY" *) output S_AXIS_MASTER_0_tready;
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 S_AXIS_MASTER_0 TSTRB" *) input [31:0]S_AXIS_MASTER_0_tstrb;
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 S_AXIS_MASTER_0 TUSER" *) input [255:0]S_AXIS_MASTER_0_tuser;
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 S_AXIS_MASTER_0 TVALID" *) input S_AXIS_MASTER_0_tvalid;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 S_AXI_0 ARADDR" *) (* X_INTERFACE_MODE = "Slave" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME S_AXI_0, ADDR_WIDTH 32, ARUSER_WIDTH 32, AWUSER_WIDTH 32, BUSER_WIDTH 0, CLK_DOMAIN axi_stream_receiver_256_s_axi_aclk_0, DATA_WIDTH 32, FREQ_HZ 100000000, HAS_BRESP 1, HAS_BURST 1, HAS_CACHE 1, HAS_LOCK 1, HAS_PROT 1, HAS_QOS 1, HAS_REGION 0, HAS_RRESP 1, HAS_WSTRB 1, ID_WIDTH 1, INSERT_VIP 0, MAX_BURST_LENGTH 256, NUM_READ_OUTSTANDING 7, NUM_READ_THREADS 1, NUM_WRITE_OUTSTANDING 7, NUM_WRITE_THREADS 1, PHASE 0.0, PROTOCOL AXI4, READ_WRITE_MODE READ_WRITE, RUSER_BITS_PER_BYTE 0, RUSER_WIDTH 0, SUPPORTS_NARROW_BURST 1, WUSER_BITS_PER_BYTE 0, WUSER_WIDTH 0" *) input [31:0]S_AXI_0_araddr;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 S_AXI_0 ARUSER" *) input [31:0]S_AXI_0_aruser;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 S_AXI_0 AWUSER" *) input [31:0]S_AXI_0_awuser;
  ...
  output [15:0]axis_err_count_0;
  input core_ext_start_0;
  input core_ext_stop_0;
  output err_out_0;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.S_AXI_ACLK_0 CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.S_AXI_ACLK_0, ASSOCIATED_BUSIF M_AXIS_MASTER_0:S_AXI_0:S_AXIS_MASTER_0, ASSOCIATED_RESET s_axi_aresetn_0, CLK_DOMAIN axi_stream_receiver_256_s_axi_aclk_0, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input s_axi_aclk_0;
  ...
  wire [255:0]M_AXIS_MASTER_0_tdata;
  wire [7:0]M_AXIS_MASTER_0_tdest;
  wire [15:0]M_AXIS_MASTER_0_tid;
  wire [31:0]M_AXIS_MASTER_0_tkeep;
  wire M_AXIS_MASTER_0_tlast;
  wire M_AXIS_MASTER_0_tready;
  wire [31:0]M_AXIS_MASTER_0_tstrb;
  wire [255:0]M_AXIS_MASTER_0_tuser;
  wire M_AXIS_MASTER_0_tvalid;
  wire [255:0]S_AXIS_MASTER_0_tdata;
  wire [7:0]S_AXIS_MASTER_0_tdest;
  wire [15:0]S_AXIS_MASTER_0_tid;
  wire [31:0]S_AXIS_MASTER_0_tkeep;
  wire S_AXIS_MASTER_0_tlast;
  wire S_AXIS_MASTER_0_tready;
  wire [31:0]S_AXIS_MASTER_0_tstrb;
  wire [255:0]S_AXIS_MASTER_0_tuser;
  wire S_AXIS_MASTER_0_tvalid;
  ...
  axi_stream_receiver_256_axi_traffic_gen_0_0 axi_traffic_gen_0
       (.axis_err_count(axis_err_count_0),
        ...
        .s_axis_1_tdata(S_AXIS_MASTER_0_tdata),
        .s_axis_1_tdest(S_AXIS_MASTER_0_tdest),
        .s_axis_1_tid(S_AXIS_MASTER_0_tid),
        .s_axis_1_tkeep(S_AXIS_MASTER_0_tkeep),
        .s_axis_1_tlast(S_AXIS_MASTER_0_tlast),
        .s_axis_1_tready(S_AXIS_MASTER_0_tready),
        .s_axis_1_tstrb(S_AXIS_MASTER_0_tstrb),
        .s_axis_1_tuser(S_AXIS_MASTER_0_tuser),
        .s_axis_1_tvalid(S_AXIS_MASTER_0_tvalid));
endmodule
