...
//Date        : Wed Aug  6 09:54:39 2025
//Host        : Juan running 64-bit major release  (build 9200)
//Command     : generate_target axi_stream_master_wrapper.bd
//Design      : axi_stream_master_wrapper
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

module axi_stream_master_wrapper
   (M_AXIS_MASTER_0_tdata,
    ...
    s_axi_aclk_0,
    s_axi_aresetn_0);
  output [1023:0]M_AXIS_MASTER_0_tdata;
  output [7:0]M_AXIS_MASTER_0_tdest;
  output [15:0]M_AXIS_MASTER_0_tid;
  output [127:0]M_AXIS_MASTER_0_tkeep;
  output M_AXIS_MASTER_0_tlast;
  input M_AXIS_MASTER_0_tready;
  output [127:0]M_AXIS_MASTER_0_tstrb;
  output [255:0]M_AXIS_MASTER_0_tuser;
  output M_AXIS_MASTER_0_tvalid;
  ...
  axi_stream_master axi_stream_master_i
       (.M_AXIS_MASTER_0_tdata(M_AXIS_MASTER_0_tdata),
        .M_AXIS_MASTER_0_tdest(M_AXIS_MASTER_0_tdest),
        .M_AXIS_MASTER_0_tid(M_AXIS_MASTER_0_tid),
        .M_AXIS_MASTER_0_tkeep(M_AXIS_MASTER_0_tkeep),
        .M_AXIS_MASTER_0_tlast(M_AXIS_MASTER_0_tlast),
        .M_AXIS_MASTER_0_tready(M_AXIS_MASTER_0_tready),
        .M_AXIS_MASTER_0_tstrb(M_AXIS_MASTER_0_tstrb),
        .M_AXIS_MASTER_0_tuser(M_AXIS_MASTER_0_tuser),
        .M_AXIS_MASTER_0_tvalid(M_AXIS_MASTER_0_tvalid),
