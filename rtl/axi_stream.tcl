...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net S_AXI_0_1 [get_bd_intf_ports S_AXI_0] [get_bd_intf_pins axi_traffic_gen_0/S_AXI]
  connect_bd_intf_net -intf_net axi_traffic_gen_0_M_AXIS_MASTER [get_bd_intf_ports M_AXIS_MASTER_0] [get_bd_intf_pins axi_traffic_gen_0/M_AXIS_MASTER]

  # Create port connections
  connect_bd_net -net axi_traffic_gen_0_err_out  [get_bd_pins axi_traffic_gen_0/err_out] \
  [get_bd_ports err_out_0]
  connect_bd_net -net core_ext_start_0_1  [get_bd_ports core_ext_start_0] \
  [get_bd_pins axi_traffic_gen_0/core_ext_start]
  connect_bd_net -net core_ext_stop_0_1  [get_bd_ports core_ext_stop_0] \
  [get_bd_pins axi_traffic_gen_0/core_ext_stop]
